...
CustomerCurated_node1693745022656 = glueContext.create_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://stedi-lake-saad/customer/curated/"], "recurse": True},
...
StepTrainerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-saad/step_trainer/landing/"],
        "recurse": True,
    },
...
StepTrainerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://stedi-lake-saad/step_trainer/trusted/",
        "compression": "snappy",
        "partitionKeys": [],
    },
