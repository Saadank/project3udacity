...
CustomerTrusted_node1693320268024 = glueContext.create_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://stedi-lake-saad/customer/trusted"], "recurse": True},
...
AccelerometerLanding_node1693320269201 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-saad/accelerometer/landing/"],
        "recurse": True,
    },
...
CustomerCurated_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"path": "s3://stedi-lake-saad/customer/curated/", "partitionKeys": []},
